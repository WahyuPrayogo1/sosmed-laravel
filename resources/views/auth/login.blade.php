...
<!-- Mirrored from social.webestica.com/sign-in-advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Jul 2022 07:42:16 GMT -->
        ...
        <div class="bg-primary pt-5 pb-0 position-relative">
            ...
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-12">
                        <!-- Title -->
                        <h1 class="display-4 text-white mb-4 position-relative">Curhat Bang!</h1>
                        <!-- SVG START -->
                  ...
                  s0.1-0.3,0.1-0.3s-0.3-0.5-1.9-0.8l0,0C224.1,86.4,222.9,86.2,221.7,86.2z" />
                    ...
                    <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
                        ...
                        <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
                            <!-- Title -->
                            <h2 class="h1 mb-2">Login</h2>
                            <p>Belum punya akun?<a href="{{ route('register') }}"> Klik di sini untuk mendaftar</a></p>
                            <!-- Form START -->
