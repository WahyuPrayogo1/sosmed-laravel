...
<!-- Mirrored from social.webestica.com/sign-up-advance.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Jul 2022 07:43:04 GMT -->
                    ...
                    <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
                        ...
                        <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
                            <div class="text-center">
                                <!-- Title -->
                                <h2 class="h1 mb-2">Daftar</h2>
                                <span class="d-block">Sudah Punya Akun? <a href="{{ route('register') }}">Login disini</a></span>
                            </div>
                            <!-- Form START -->
                            <form class="mt-4" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3 input-group-lg">
                                    <input name="name" required id="name" type="text"
                                        class="form-control" placeholder="Masukan Nama" value="{{ old('name') }}">
                                    @if ($errors->has('name'))
                                ...
                                <!-- Email -->
                                <div class="mb-3 input-group-lg">
                                    <input name="number" required id="number" type="number"
                                        class="form-control" placeholder="Masukan Nomer HP"
                                        value="{{ old('number') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input class="form-control fakepassword" type="password" name="password"
                                                required autocomplete="current-password" id="psw-input"
                                    ...
                                    <div class="d-flex mt-1">
                                        ...
                                        <div class="ms-auto">
                                            <i class="bi bi-info-circle ps-1" data-bs-container="body"
                                                ...
                                                data-bs-content="Sertakan setidaknya satu huruf besar, satu huruf kecil, satu karakter khusus, satu angka, dan panjang 8 karakter."
                                ...
                                <!-- Button -->
                                <div class="d-grid"><button type="submit" class="btn btn-lg btn-primary">Daftar
                                        Sekarang</button></div>
                                <!-- Copyright -->
                            </form>
                            <!-- Form END -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-10 col-md-8 col-lg-6">
                    <div class="d-grid d-sm-flex justify-content-center align-items-center mt-3">
                        <!-- Nav -->
                        <ul class="nav">
